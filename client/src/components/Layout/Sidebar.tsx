...
export function Sidebar() {
  ...
  const getNavItemClass = (href: string) => {
    ...
    const base = "flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200";
    return isActive ? `${base} bg-primary/10 text-primary font-medium` : `${base} text-muted-foreground hover:bg-muted hover:text-foreground`;
  };
        ...
        {isDevMode && (
          <>
            <div className="pt-2 pb-1">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/60 px-4">Developer</p>
            </div>
